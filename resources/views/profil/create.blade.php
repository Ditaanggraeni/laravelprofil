...
@section('title', 'Tambah Data Kamera')
                    ...
                    <div class="card-body">
                        <form action="{{ route('kamera.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('kategori_id') is-invalid @enderror" name="kategori_id" value="{{ old('kategori_id') }}" placeholder="Masukkan Id Kategori Kamera">
